      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-charcoal/70 max-w-3xl mx-auto">
            Discover the rich cultural tapestry behind every spice, from the
            dedicated farmers who grow them to the ancient traditions that
            shaped their use.
          </p>
        </motion.div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <h4 className="font-luxury text-burgundy">
                          {producer.name}
                        </h4>
                  ...
                  >
                    <Card className="luxury-shadow">
                        ...
                        <div className="flex items-start justify-between">
                          ...
                          <div className="text-right">
                            <Badge className="bg-golden hover:bg-golden text-charcoal">
                              {selectedProducer.generationsInBusiness}{" "}
                              Generations
                            </Badge>
                          </div>
                        </div>
                      ...
                      <CardContent>
                        ...
                        {/* Story */}
                        <div className="mb-6">
                          <h4 className="font-semibold text-burgundy mb-3">
                            Their Story
                          </h4>
                          <p className="text-charcoal/80 leading-relaxed">
                            {selectedProducer.story}
                          </p>
                        </div>
                        ...
                        <div className="mb-6">
                          ...
                          <div className="space-y-2">
                            {selectedProducer.achievements.map(
                              (achievement, index) => (
                                <div
                                  key={index}
                        ...
                        <div>
                          ...
                          <div className="space-y-2">
                            {selectedProducer.sustainabilityPractices.map(
                              (practice, index) => (
                                <div
                                  key={index}
                                  className="flex items-center gap-2"
                  ...
                  <Card className="luxury-shadow h-full">
                    <CardHeader>
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <Badge
                          variant="outline"
                          className="border-copper text-copper"
                        >
                          {story.period}
                        </Badge>
                      </div>
                    ...
                    <CardContent>
                      ...
                      <div className="space-y-3">
                        <div>
                          <h5 className="font-semibold text-burgundy text-sm">
                            Significance
                          </h5>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1 mt-1">
                            {story.relatedSpices.map((spice) => (
                              <Badge
                                key={spice}
                                className="text-xs bg-golden/20 text-golden hover:bg-golden/20"
                              >
                                {spice}
                              </Badge>
                            ))}
                    ...
                    <CardContent>
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <div className="space-y-4">
                            <div>
                              <h5 className="font-semibold text-burgundy mb-2">
                                Spices Used
                              </h5>
                              <div className="flex flex-wrap gap-2">
