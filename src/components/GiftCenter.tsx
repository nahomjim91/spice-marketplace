...
export default function GiftCenter() {
  ...
  const occasionOptions = [
    'Birthday', 'Anniversary', 'Wedding', 'Housewarming', 
    'Holiday', 'Thank You', 'Corporate', 'Cultural Celebration'
  ];
  ...
  const subscriptionGifts = giftOptions.filter(gift => gift.type === 'subscription');
  const corporateGifts = giftOptions.filter(gift => gift.type === 'corporate');
  ...
  const calculateTotal = () => {
    ...
    const wrapPrice = giftWrapOptions.find(wrap => wrap.id === customization.giftWrap)?.price || 0;
            ...
            >
              ...
              <div className="grid lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-6">
                  <Card className="luxury-shadow border-0">
                    <CardHeader>
                      ...
                      <p className="text-charcoal/70">{selectedGift.description}</p>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      ...
                      <div className="pt-4 border-t border-charcoal/10">
                        <div className="flex items-center justify-between mb-4">
                          <span className="font-medium text-burgundy">Quantity:</span>
                          <div className="flex items-center gap-2">
                            ...
                            <span className="w-8 text-center font-medium">{giftQuantity}</span>
                            <Button 
                              variant="outline" 
                              size="sm"
                        ...
                        <div className="bg-warm-beige/20 rounded-lg p-4">
                          ...
                          {customization.includeCard && (
                            <div className="flex justify-between text-sm mb-2">
                              ...
                              <span>${giftWrapOptions.find(wrap => wrap.id === customization.giftWrap)?.price || 0}</span>
                            </div>
                          )}
                          <div className="border-t border-charcoal/10 pt-2 flex justify-between font-medium">
                            <span>Total</span>
                            <span className="text-saffron">${calculateTotal()}</span>
                          </div>
                        </div>
                      </div>
                    </CardContent>
                ...
                <div className="space-y-6">
                  <Card className="luxury-shadow border-0">
                    <CardHeader>
                      <h3 className="font-luxury text-xl text-burgundy">Personalize Your Gift</h3>
                      <p className="text-charcoal/70">Add a personal touch to make this gift truly special.</p>
                    </CardHeader>
                    <CardContent className="space-y-6">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => setCustomization(prev => ({ ...prev, senderName: e.target.value }))}
                            placeholder="From"
                            className="border-copper/20 focus:border-saffron"
                          />
                        </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          {giftWrapOptions.map(wrap => (
                            <div key={wrap.id} className="flex items-center justify-between p-3 border rounded-lg hover:bg-warm-beige/20 transition-colors">
                              <div className="flex items-center gap-3">
                                <input
                                  ...
                                  onChange={(e) => setCustomization(prev => ({ ...prev, giftWrap: e.target.value }))}
                                  className="text-saffron"
                                />
                                <div>
                                  <div className="font-medium text-burgundy">{wrap.name}</div>
                                  <div className="text-sm text-charcoal/60">+${wrap.price}</div>
                                </div>
                              </div>
                      ...
                      <div className="flex items-center gap-3">
                        <input
                          ...
                          onChange={(e) => setCustomization(prev => ({ ...prev, includeCard: e.target.checked }))}
                          className="text-saffron"
                        />
                        <span className="text-sm text-charcoal/70">Include personalized gift card</span>
                      </div>
                    </CardContent>
                  </Card>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 mb-6 px-6 py-2 bg-burgundy/10 border border-burgundy/20 rounded-full">
              ...
              <span className="text-sm font-medium text-burgundy tracking-wider">LUXURY GIFT CENTER</span>
            </div>
            ...
            <p className="text-xl text-charcoal/80 max-w-3xl mx-auto leading-relaxed">
              Share the rich heritage of Ethiopian and Eritrean cuisine with beautifully curated gift collections,
              perfect for any occasion and any level of culinary curiosity.
            </p>
          </motion.div>
        </div>
      </section>
                ...
                {oneTimeGifts.map((gift, index) => (
                  ...
                  >
                    <Card className="overflow-hidden border-0 luxury-shadow hover:spice-glow transition-luxury h-full">
                      ...
                      <CardContent className="space-y-6">
                        <div>
                          <h4 className="font-medium text-burgundy mb-3 text-sm">What's Included:</h4>
                          <div className="space-y-2">
                            {gift.includes.slice(0, 4).map((item, itemIndex) => (
                        ...
                        <div className="p-4 bg-golden/10 rounded-lg">
                          ...
                          <p className="text-xs text-charcoal/70">{gift.presentation}</p>
                        </div>
                        
                        <div className="flex flex-wrap gap-2">
                          {gift.ideal_for.slice(0, 3).map((audience, audienceIndex) => (
                            <Badge 
                              key={audienceIndex}
                              variant="outline" 
              ...
              <div className="space-y-8">
                <div className="text-center mb-12">
                  ...
                  <p className="text-lg text-charcoal/70 max-w-2xl mx-auto">
                    Give the experience of monthly spice discovery with our subscription gift options.
                    Recipients receive beautifully curated boxes for their chosen duration.
                  </p>
                </div>
            ...
            <TabsContent value="corporate">
              <div className="space-y-8">
                <div className="text-center mb-12">
                  ...
                  <p className="text-lg text-charcoal/70 max-w-2xl mx-auto">
                    Impress clients, partners, and employees with sophisticated gifts that showcase
                    Ethiopian heritage and your company's appreciation for cultural excellence.
                  </p>
                </div>
                        ...
                        <div className="grid lg:grid-cols-3 gap-8 items-center">
                          <div className="lg:col-span-2">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                              <div>
                                <h4 className="font-medium text-golden mb-3">Collection Includes:</h4>
                                <div className="space-y-2">
                                  {gift.includes.slice(0, 4).map((item, itemIndex) => (
                                    <div key={itemIndex} className="flex items-start gap-2">
                              ...
                              <div>
                                <h4 className="font-medium text-golden mb-3">Corporate Services:</h4>
                                <div className="space-y-2">
                                  {gift.corporate_features?.slice(0, 4).map((feature, featureIndex) => (
                          ...
                          <div className="space-y-4">
                            <div className="p-6 bg-white/10 rounded-lg backdrop-blur-sm">
                              <h4 className="font-medium text-golden mb-4 text-center">Perfect For:</h4>
                              <div className="space-y-2">
                            ...
                            <Button 
                              className="w-full bg-golden hover:bg-copper text-burgundy font-medium py-3"
                              onClick={() => handleGiftSelect(gift)}
                            >
      ...
      <section className="py-16 bg-warm-beige/20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-charcoal/70 max-w-2xl mx-auto">
              Every gift is handled with the utmost care and attention to detail,
              ensuring your gesture makes a lasting impression.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: 'Hand-crafted presentation boxes with Ethiopian textile accents'
              },
              {
                icon: <MessageCircle className="w-6 h-6" />,
                title: 'Personal Messages',
                description: 'Custom cards with your heartfelt message in beautiful calligraphy'
              },
              {
                icon: <Truck className="w-6 h-6" />,
                title: 'Precise Delivery',
                description: 'Schedule delivery for the perfect moment with tracking updates'
              },
              {
                icon: <Clock className="w-6 h-6" />,
                title: 'Concierge Support',
                description: 'Dedicated gift specialists to help you choose the perfect collection'
              }
            ].map((service, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                <h3 className="font-medium text-burgundy mb-2">{service.title}</h3>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 leading-relaxed">
              Our gift specialists are here to help you find the perfect collection
              for any occasion, taste preference, or budget.
            </p>
